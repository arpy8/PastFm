...
class LastFmClient:
    ...
    def get_current_track(self) -> Optional[Dict[str, Any]]:
        ...
        """
        try:
            # Get extended track info with better imagery
            scrobble_url = self._build_url("user.getRecentTracks", extended=True)
            
            # Get basic track info with "now playing" status
            ...
            # Parse responses
            scrobble_data = json.loads(scrobble_response.text)['recenttracks']["track"][0]
